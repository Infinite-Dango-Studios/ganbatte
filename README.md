...
Any other code used by this game is licensed under The MIT License, with the exception of the strings contained within the code which are considered as writing in terms of the licensing of this game. Any parts this game including not defined earlier in the game's licensing including, but not limited to artwork, sprites, writing, and music are released under the CC BY-NC-ND 3.0 license. 
